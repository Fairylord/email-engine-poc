...
import test.aop.aspect.Immutable;
import test.aop.aspect.Tv;
 ...
 * @version $Id$
 * @since 0.1.10
 * @see test.aop.annotation.RetryOnFailure
 */
@Aspect
@Immutable
public final class Repeater {
     ...
     */
    @Around("execution(* * (..)) && @annotation(test.aop.annotation.RetryOnFailure)")
